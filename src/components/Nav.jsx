    ...
    <nav className="bg-zinc-950 border-b border-zinc-800 py-4">
      <div className="max-w-7xl mx-auto flex justify-between">
        ...
        <div className="flex gap-3 items-center justify-center">
          ...
          <button
            onClick={onReset}
            className="bg-red-600 hover:bg-red-500 text-white text-sm px-4 py-2 rounded-xl transition duration-200 shadow-lg shadow-red-600/20 cursor-pointer"
          >
            إعادة تعيين
          </button>
          ...
          >
            <FaGithub className="text-zinc-400 text-[28px] hover:text-white transition-colors duration-300" />
          </a>
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <FaLinkedin className="text-zinc-400 text-[28px] hover:text-blue-400 transition-colors duration-300" />
          </a>
        </div>
      </div>
    </nav>
